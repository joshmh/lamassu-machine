...
function updateConfig (config, key) {
  ...
  var fingerprint = crypto.createHash('sha256').update(configEnc).digest().slice(0, 8)
  var params = {
    Item: {
...
function pair (machineId) {
  ...
  var broadcast = new Buffer('AAAFqCyZlG6KhpFrQAbhI8AU95xpD5J2RJc', 'base64')
  var direct = new Buffer('AAC9WSC3nOT1Li+8058RJ3a3mO6S2WQBPtw=', 'base64')
...
var broadcastKey = new Buffer('AAAFqCyZlG6KhpFrQAbhI8AU95xpD5J2RJc', 'base64')
