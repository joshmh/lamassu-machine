...
var idleEmitter = new EventEmitter()
...
Brain.prototype.log = function log (cat, data) {
  this.logEmitter.emit('log', {category: cat, data: data})
}
...
Brain.prototype._initLog = function initLog () {
  ...
  let newLog$ = Rx.Observable.fromEvent(this.logEmitter, 'log')
  ...
  let fullLog$ = Log.init('990685c8-80e4-4344-b6d1-bd288f031b2f', cats, newLog$, key$)
