...
Brain.prototype._initLog = function initLog () {
  ...
  .subscribe(r => {
    ...
    phoneMap.set(r.phone, (phoneMap.get(r.phone) || new Set()).add(r.sessionId))
  })
  ...
  .subscribe(r => {
    if (r.phone) {
      let sessionIds = phoneMap.get(r.phone)
      if (sessionIds) sessionIds.delete(r.sessionId)
      sessionMap.delete(r.sessionId)
    }
