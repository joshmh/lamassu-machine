...
Brain.prototype._pairing = function _pairing () {
  ...
  .then(() => {
    ...
    return pairing.fetchDeviceRecord(otp)
  })
  .then(r => {
    ...
    return pairing.sendEncryptedNonce(r.nonce, ltk)
    .then(() => {
...
Brain.prototype._pairingCode = function _pairingCode (code) {
  ...
  this.log('activities', {
    event: 'pairing',
    ltk: this.allegedDevice.ltk,
    deviceId: this.allegedDevice.deviceId
  })
}
